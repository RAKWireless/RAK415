...
#define SPI_SSR_SW_SS_PIN_LOW              (0x0)  /*!< SPI_SSR setting to force SPI master SS signal to low by software */
#define SPI_SSR_SW_SS_PIN_HIGH             (0x1)  /*!< SPI_SSR setting to force SPI master SS signal to high by software */
